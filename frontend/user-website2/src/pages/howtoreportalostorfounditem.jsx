      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Use your registered credentials to log in to the U-FIND platform. This
              ensures your report is tracked and linked to your account.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-gray-800 mb-2">
            ...
            <p className="text-gray-700 leading-relaxed">
              Click on the "Item Lost" section in the sidebar of the dashboard. This
              page is specifically designed for users to report missing items.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-gray-800 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Double-check the information provided and submit your report. You will
              receive a confirmation notification, and your report will be visible in
              the system for admins and users to match.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-gray-800 mb-2">
            ...
            <p className="text-gray-700 leading-relaxed">
              Stay updated by checking notifications or messages. U-FIND’s system
              will alert you if a similar item is reported as found.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8 mt-12">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Ensure you are logged in to the system. This helps us keep track of
              your contributions and makes communication seamless.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-gray-800 mb-2">
            ...
            <p className="text-gray-700 leading-relaxed">
              On the sidebar, click the "Item Found" section. This is where you can
              log items that you have found.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold text-gray-800 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              After verifying all the details, submit the report. The system will
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Once the rightful owner is identified, U-FIND’s admin team will contact
