...
export const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await register({ firstName, lastName, emailAddress, contactNumber, password });
  ...
  return (
    <div className="h-screen flex justify-center items-center bg-gradient-to-br from-blue-500 to-cyan-400">
      <div className="bg-white p-10 rounded-lg shadow-lg max-w-md w-full text-center">
        <h2 className="mb-6 text-2xl text-gray-800 font-semibold">USER REGISTRATION</h2>
        ...
        <form onSubmit={handleRegister}>
          ...
          <button type="submit" className="w-full py-3 bg-blue-500 text-white rounded hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500">REGISTER</button>
        </form>
