        ...
        <aside className="w-1/6 bg-white shadow-lg p-6">
          ...
          <nav>
            <ul className="space-y-4">
              ...
              <li className="hover:text-blue-500 cursor-pointer">
                <Link to="/item-lost">Lost Items</Link>
              </li>
              <li className="hover:text-blue-500 cursor-pointer">
              ...
              <li className="hover:text-blue-500 cursor-pointer">
                <Link to="/turnover-tickets">Turnover Tickets</Link>
              </li>
              <li className="hover:text-blue-500 cursor-pointer">
                <Link to="/unclaimed-tickets">Unclaimed Tickets</Link>
              </li>
              <li className="hover:text-blue-500 cursor-pointer">
                <Link to="/">Logout</Link>
              </li>
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="bg-white p-4 rounded-lg shadow-lg">
              <h2 className="text-lg font-bold text-center mb-4">Grand Total</h2>
